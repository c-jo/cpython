...
class TestRiscospath(RiscospathTestCase):
    ...
    def test_splitdrive(self):
        self.assertEqual(riscospath.splitdrive("SDFS::RISCOSPi.$"),
               ('SDFS::RISCOSPi.', '$'))
        self.assertEqual(riscospath.splitdrive("Net#1.253:&.Spam"),
               ('Net#1.253:', '&.Spam'))
        self.assertEqual(riscospath.splitdrive("Resources:$.Apps"),
               ('Resources:', '$.Apps'))
        self.assertEqual(riscospath.splitdrive(":0.$.Work"),
               (':0.', '$.Work'))
        self.assertEqual(riscospath.splitdrive(":0"),
               (':0', ''))
        self.assertEqual(riscospath.splitdrive("SDFS::RISCOSPi"),
               ('SDFS::RISCOSPi', ''))
        self.assertEqual(riscospath.splitdrive("$.Work"),
               ('', '$.Work'))
        self.assertEqual(riscospath.splitdrive("ADFS:"),
               ('ADFS:', ''))

    def test_split(self):
        self.assertEqual(riscospath.split("SDFS::RISCOSPi.$.foo.bar"),
            ('SDFS::RISCOSPi.$.foo', 'bar'))
        self.assertEqual(riscospath.split("SDFS::RISCOSPi"),
            ('', 'SDFS::RISCOSPi'))
        self.assertEqual(riscospath.split("SDFS::RISCOSPi.$"),
            ('SDFS::RISCOSPi', '$'))
        self.assertEqual(riscospath.split("Eggs.Chips.Spam"),
            ('Eggs.Chips', 'Spam'))
        self.assertEqual(riscospath.split("Eggs.Chips.."),
            ('Eggs.Chips', ''))
        self.assertEqual(riscospath.split(""),
            ('', ''))
    ...
    def test_commonprefix(self):
        self.assertEqual(riscospath.commonprefix(
            ["$.swenson.spam", "$.swen.spam"]),
            "$.swen")
        self.assertEqual(riscospath.commonprefix(
            ["$.swen.spam", "$.swen.eggs"]),
            "$.swen.")
